...
Gem::Specification.new do |s|
  ...
  s.files = ["lib/ohm/compat-1.8.6.rb", "lib/ohm/helpers.rb", "lib/ohm/key.rb", "lib/ohm/pattern.rb", "lib/ohm/serialized.rb", "lib/ohm/timestamps.rb", "lib/ohm/utils/upgrade.rb", "lib/ohm/validations.rb", "lib/ohm/version.rb", "lib/ohm.rb", "README.markdown", "LICENSE", "Rakefile", "test/1.8.6_test.rb", "test/associations_test.rb", "test/connection_test.rb", "test/errors_test.rb", "test/hash_key_test.rb", "test/helper.rb", "test/indices_test.rb", "test/json_test.rb", "test/model_test.rb", "test/mutex_test.rb", "test/pattern_test.rb", "test/poly_test.rb", "test/upgrade_script_test.rb", "test/validations_test.rb", "test/wrapper_test.rb", "test/test.conf"]
  s.rubyforge_project = "ohm"
  s.add_dependency "nest", "~> 1.0"
  s.add_dependency "redis-rb", "~> 3.0.1"
